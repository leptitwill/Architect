...
class Faq_operatoire extends CI_Controller
{
	...
	{
		$this->data['titre'] = 'Gestion du mode opératoire';
		...
		$this->load->view('faq_operatoire/accueil-admin', $this->data);
	...
	public function creer()
	{
		...
		$this->load->view('theme/header-admin', $this->data);
		$this->load->view('faq_operatoire/creer', $this->data);
	...
	public function modifier($id)
	{
		...
		$this->data['attributs'] = array('class' => 'creer');
		$this->data['faq'] = $this->faq_operatoire_model->selectionner_faq($id);
		$this->data['error'] = $this->session->flashdata('error');
		$this->data['succes'] = $this->session->flashdata('succes');

		$this->load->view('theme/header-admin', $this->data);
		$this->load->view('faq_operatoire/modifier', $this->data);
		$this->load->view('theme/footer-admin', $this->data);
	}

	public function supprimer($id)
	{
		$this->faq_operatoire_model->supprimer_faq($id);

		$this->session->set_flashdata('succes','<p>La question à bien était supprimé</p>');
		redirect("admin/faq_operatoire");
	}
	...
	public function upload()
	{
		...
		{
			$this->faq_operatoire_model->ajouter_faq($question, $reponse);
	...
	public function update($id)
	{
		...
		{
			$this->faq_operatoire_model->modifier_faq($id, $question, $reponse);
