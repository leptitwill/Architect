		<section class="content-admin">
			...
			<?php echo form_open_multipart('admin/membre/update/'.$membre_id, $attributs); ?>
				...
				<input type="text" name="prenom" placeholder="Alain" value="<?= $membre[0]['prenom'] ?>"/><br />

				<label for="nom">Nom</label>
				<input type="text" name="nom" placeholder="Alain Delon" value="<?= $membre[0]['nom'] ?>"/><br />

				<label for="email">Email</label>
				<input type="mail" name="email" placeholder="alain.delon@gmail.com" value="<?= $membre[0]['email'] ?>"/><br />

				<label for="role">Rôle</label>
				<input type="text" name="role" placeholder="Acteur et réalisateur" value="<?= $membre[0]['role'] ?>"/><br />
