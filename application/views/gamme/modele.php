<section class="gamme">
	...
	<section class="gamme_info">
		...
		<div class="gamme_gallery" style="background-image: url('<?=img_url()?>gamme/<?=$gamme[0]['couverture']?>')"></div>
	...
	<section class="gamme_sidebar">
		...
		<div class="gamme_pdf"><a href="">&#10141; Télécharger le pdf</a></div>
