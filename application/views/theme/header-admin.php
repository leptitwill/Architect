	...
	<body class="body_admin">
		...
		<aside class="connexion_sidebar">
			...
			<ul>
				...
				<span>
					<li id="social" class="<?php if($this->uri->segment(2)=="reseaux_sociaux" || $this->uri->segment(2)=="partenaire" || $this->uri->segment(2)=="faq" || $this->uri->segment(2)=="avis") {echo "active";}?>">
						<span>
					...
					<li id="menu_social" class="sous-menu" style="<?php if($this->uri->segment(2)=="reseaux_sociaux" || $this->uri->segment(2)=="partenaire" || $this->uri->segment(2)=="faq" || $this->uri->segment(2)=="avis"){echo "display: block";}else{echo "display:none";}?>">
						<ul>
