		<section class="content">
			...
			<a href="<?= base_url("Produit/creer"); ?>"><input type="button" class="button" value="Ajouter un produit"></a>
			...
			<?php foreach ($produits as $produit): ?>
				...
				<article class="produit">
					...
					<div class="modifier_produit">
						<a href="<?= base_url("produit/modifier/$produit_id"); ?>" id="<?= $produit['idProduit'] ?>">
					...
					<div class="supprimer_produit">
						<a href="<?= base_url("produit/supprimer/$produit_id"); ?>" id="<?= $produit['idProduit'] ?>" onclick="return(confirm('Etes-vous sûr de vouloir supprimer ce produit ?'));">
							<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="30px" height="30px" viewBox="0 0 48 48" enable-background="new 0 0 48 48" xml:space="preserve">
