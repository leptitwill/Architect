			...
			<?php foreach ($produits as $produit): ?>
				...
				<article class="produit">
					...
					<div class="modifier_produit">
						<a href="<?= base_url("admin/produit/modifier/$produit_id"); ?>" id="<?= $produit_id ?>">
					...
					<div class="supprimer_produit">
						<span id="<?= $produit_id ?>" onclick="supprimerReseauSocial()">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		...
		<script type="text/javascript">
			...
			function supprimerReseauSocial(){
				swal({
					...
					if (isConfirm) {
				    	window.location.href = '<?= base_url("admin/produit/supprimer/$produit_id") ?>';
					}
				})
			}
