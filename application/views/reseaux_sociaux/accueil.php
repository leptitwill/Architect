			...
			<?php foreach ($reseaux_sociaux as $reseau_social): ?>
				...
				<article class="reseaux_sociaux">
					...
					<div class="supprimer_reseaux_sociaux">
						<span id="<?= $reseaux_sociaux_id ?>" onclick="supprimerReseauSocial()">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
		...
		<script type="text/javascript">
			...
			function supprimerReseauSocial(){
				swal({
					...
					if (isConfirm) {
				    	window.location.href = '<?= base_url("admin/reseaux_sociaux/supprimer/$reseaux_sociaux_id") ?>';
					}
				})
			}
