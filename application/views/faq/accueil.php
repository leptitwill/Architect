		<section class="content">
			...
			<a href="<?= base_url("faq/creer"); ?>"><input type="button" class="button" value="Ajouter une question"></a>
			...
			<?php foreach ($faqs as $faq): ?>
				...
				<article class="faq">
					...
					<div class="modifier_faq">
						<a href="<?= base_url("faq/modifier/$faq_id"); ?>" id="<?= $faq['idFaq'] ?>">
					...
					<div class="supprimer_faq">
						<a href="<?= base_url("faq/supprimer/$faq_id"); ?>" id="<?= $faq['idFaq'] ?>" onclick="return(confirm('Etes-vous sûr de vouloir supprimer cette question ?'));">
							<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="30px" height="30px" viewBox="0 0 48 48" enable-background="new 0 0 48 48" xml:space="preserve">
