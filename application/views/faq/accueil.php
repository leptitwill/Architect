		<section class="content-admin">
			...
			<?php foreach ($faqs as $faq): ?>
				...
				<article class="faq">
					...
					<div class="modifier_faq">
						<a href="<?= base_url("admin/faq/modifier/$faq_id"); ?>" id="<?= $faq['idFaq'] ?>">
			...
			<a href="<?= base_url("admin/faq/creer"); ?>"><input type="button" class="button" value="Ajouter une question"></a>
		...
		<script type="text/javascript">
			...
			function supprimerQuestion(id){
				swal({
					...
					if (isConfirm) {
				    	window.location.href = '<?= base_url() ?>admin/faq/supprimer/' + id;
					}
				})
			}
