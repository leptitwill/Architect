			...
			<?php foreach ($membres as $membre): ?>
				...
				<article class="membre">
					...
					<div class="modifier_membre">
						<a href="<?= base_url("admin/membre/modifier/$membre_id"); ?>" id="<?= $membre['idMembre'] ?>">
					...
					<div class="supprimer_membre">
						<span id="<?= $membre['idMembre'] ?>" onclick="supprimerMembre(<?= $membre['idMembre'] ?>)">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
					...
					<div class="membre_info">
						...
						<div class="membre_description"><?= $membre['description'] ?></div>	
					</div>
		...
		<script type="text/javascript">
			...
			function supprimerMembre(id){
				swal({
					...
					if (isConfirm) {
				    	window.location.href = '<?= base_url() ?>admin/membre/supprimer/' + id;
					}
				})
			}
