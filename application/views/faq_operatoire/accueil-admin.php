		<section class="content-admin">
			...
			<?php foreach ($faqs as $faq): ?>
				...
				<article class="faq">
					...
					<div class="modifier_faq">
						<a href="<?= base_url("admin/faq_operatoire/modifier/$faq_id"); ?>" id="<?= $faq['idFaq'] ?>">
					...
					<div class="supprimer_faq">
						<span id="<?= $faq['idFaq'] ?>" onclick="supprimerQuestion(<?= $faq['idFaq'] ?>)">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
			...
			<a href="<?= base_url("admin/faq_operatoire/creer"); ?>"><input type="button" class="button" value="Ajouter une question"></a>
		...
		<script type="text/javascript">
			...
			function supprimerQuestion(id){
				swal({
					...
					text: "Une fois supprimé la question ne sera plus disponible.",
					...
					if (isConfirm) {
				    	window.location.href = '<?= base_url() ?>admin/faq_operatoire/supprimer/' + id;
					}
				})
			}
